...
public class ConnectToServer : MonoBehaviourPunCallbacks{
    ...
    [SerializeField] GameObject image_alarm;
    [SerializeField] TextMeshProUGUI text_alarm;
    ...
    private void Update() {
        ...
        if(Input.anyKey){
            ...
            image_alarm.SetActive(false);
        }
    }
    public void OnClickConnect(){
        if(Check(usernameInput.text)){
            PhotonNetwork.NickName = usernameInput.text;
            buttonText.text = "Łączenie...";
            PhotonNetwork.AutomaticallySyncScene = true;
            PhotonNetwork.ConnectUsingSettings();
        }else{
            panel.SetActive(true);
            image_alarm.SetActive(true);
        }
    }
